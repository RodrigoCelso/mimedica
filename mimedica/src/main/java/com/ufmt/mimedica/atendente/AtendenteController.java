...
public class AtendenteController {
    ...
    public ResponseEntity<AtendenteResponse> getById(@PathVariable int id){
        ...
        if(found.isPresent()){
            AtendenteResponse response = AtendenteResponse.from(found.get());
    ...
    public ResponseEntity<String> cadastrar(@RequestBody AtendenteRequest request){        
        Atendente dados = AtendenteRequest.transcribe(request);
    ...
    public ResponseEntity<String> atualizar(@PathVariable int id,
        ...
        Atendente atendente = AtendenteRequest.transcribe(request);
        atendente.setId(id);
